...
export default function Profile() {
  ...
  useEffect(() => {
    ...
    setUser({
      ...
      claims: [
        {
          content: 'The Earth completes one rotation in 24 hours.',
          timestamp: new Date().toISOString(),
          status: 'verified',
          verificationDetails: 'Verified through astronomical data and scientific consensus.'
        },
        {
          content: 'Water boils at 100 degrees Celsius at sea level.',
          timestamp: new Date(Date.now() - 86400000).toISOString(),
          status: 'verified',
          verificationDetails: 'Confirmed through scientific literature and experimental data.'
        },
      ],
    });
  }, [params.id]);
  ...
  if (!user) {
    return <div className="min-h-screen bg-[#343541] text-white flex items-center justify-center">Loading...</div>;
  }
        ...
        <div className="bg-[#444654] rounded-lg shadow-lg p-6">
          ...
          <div className="grid grid-cols-3 gap-4 mt-6">
            <div className="bg-[#40414f] p-4 rounded-lg">
              <div className="text-2xl font-bold text-[#10a37f]">{user.credibilityScore}%</div>
              <div className="text-gray-400">Credibility Score</div>
            </div>
            <div className="bg-[#40414f] p-4 rounded-lg">
              <div className="text-2xl font-bold text-white">{user.verifiedClaims}</div>
              <div className="text-gray-400">Verified Claims</div>
            </div>
            <div className="bg-[#40414f] p-4 rounded-lg">
              <div className="text-2xl font-bold text-white">{user.totalClaims}</div>
